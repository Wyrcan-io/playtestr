...
- [ ] Three native hosts, current contracts and correct report evidence verified.
- [ ] Action source validated; public revision and later-release gates clearly separated.
