...
Sprint 7's compact failure report is implemented from existing evidence without
Sprint 6 and published in the natively verified `v0.3.0-rc.1` prerelease.
Independent feedback is deferred until after Sprint 10. Keep the existing
